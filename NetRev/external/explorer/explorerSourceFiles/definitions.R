...
#      tags$a(href="2012CatcherVessel.jpg", 'infographic.', target="_blank")) 
  ...
  tags$div(style= "margin-top: 15px;",
   ...
   h4("Summary Variables"),
     tags$ul(
       ...
       tags$li(strong("State:"), "The state corresponding to each homeport. Vessels that fished of the West coast but report their homeport to be in Alaska are included. These vessels are included in the Puget Sound port.")
      ),  tags$br(),             
  ...
  tags$ul(
    ...
    ,tags$br(),
      ...
      tags$ul(tags$em("Values reported in inflation adjusted 2014 dollars.")),
      tags$ul(
