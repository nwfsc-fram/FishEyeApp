         ...
         HTML("<div style='display:inline-block;width:100%;padding:0;line-height: 0.72em; margin-top:5px; margin-bottom:5px;'>
           ...
           tags$div(style= "margin-top: 15px;",
                    ...
                    tags$ul(h4(tags$em('Social and Regional')),
                            ...
                            tags$li(strong('Revenue per position-day: '),'Revenue divided by position day, where position days are calculated as days at sea multipled by number of positions per vessel. This metric is a measure of productivity (in terms of revenue generation) of captain and crew.'),
