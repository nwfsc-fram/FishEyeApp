         ...
         HTML("<div style='display:inline-block;width:100%;padding:0;line-height: 0.72em; margin-top:5px; margin-bottom:5px;'>
           ...
           tags$div(style= "margin-top: 15px;",
                    ...
                    tags$ul(h4(tags$em('Labor')),
                            tags$li(strong('Number of positions: '),
                                    'Number of positions (including captain and crew) is a lower bound for employment in the fishery. The metric is affected by positions per vessel and the number of vessels fishing.'),
                            ...
                            tags$li(strong('Revenue per position-day: '),
                                    'Revenue divided by position-days, where position-days are calculated as days at sea multipled by number of positions per vessel. This metric is a measure of productivity (in terms of revenue generation) of captain and crew.')
                            ),
