        ...
        the facility. For these reasons, the aggregated measures of costs presented here underestimate the true costs of operating a business.')
                    ...
                    tags$ul(h4(tags$em('Impacts')),
                            ...
                            tags$li(strong('Income impacts: '),
                                    'Income impacts generated by the selected vessels for activities in the selected fishery. Impacts are for the West Coast overall.'),
                            tags$li(strong('Employment impacts: '),
                                    'Number of jobs generated by the selected vessels for activities in the selected fishery. Impacts are for the West Coast overall.')
                    ),
                    tags$br(),
