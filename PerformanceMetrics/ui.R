...
function(request) {
  fluidPage(title = "FISHEyE",
    ...
    tags$head(
      ...
      ##These are used to gray out different metrics when grouping by 'Metrics'. i.e., items 2-5 are grayed out in ckboxCV
      tags$style(HTML(".ckboxCV .checkbox:nth-child(2) label{color:grey;} .checkbox.input:nth-child(2),
                           ...
                           .ckboxCV .checkbox:nth-child(5) label{color:grey;} .checkbox.input:nth-child(5),
                           .ckboxCV2 .checkbox:nth-child(1) label{color:grey;} .checkbox.input:nth-child(1),
                           .ckboxCV3 .checkbox:nth-child(2) label{color:grey;} .checkbox.input:nth-child(2),
                           ...
                           .ckboxSOC .checkbox:nth-child(5) label{color:grey;} .checkbox.input:nth-child(5),
                           .ckboxSOC2 .checkbox:nth-child(3) label{color:grey;} .checkbox.input:nth-child(3),
                           .ckboxSOC2 .checkbox:nth-child(4) label{color:grey;} .checkbox. input:nth-child(4),
                           .ckboxSOC3 .checkbox:nth-child(3) label{color:grey;} .checkbox. input:nth-child(3),
      ...
      tags$style(HTML(".StatGrey  .radio:first-child  input[type=radio],
                                            ...
                                            .ckboxCV  .checkbox:nth-child(5)  input[type=checkbox],
                                            ...
                                            .ckboxCV3  .checkbox:nth-child(2)  input[type=checkbox],
                                            ...
                                            .ckboxSOC  .checkbox:nth-child(5)  input[type=checkbox],
                                            .ckboxSOC2  .checkbox:nth-child(3)  input[type=checkbox],
                                            .ckboxSOC2  .checkbox:nth-child(4)  input[type=checkbox],
                                            .ckboxSOC3  .checkbox:nth-child(3)  input[type=checkbox] {border: 0px;    width: 0%;    height:0em;}#")),
