  ...
  fluidPage(title = "FISHEyE",
    ...
    tags$head(
      ...
      tags$style(HTML(".ckbox23457 .checkbox:nth-child(2) label{color:grey;} .checkbox.input:nth-child(2),
                           ...
                           .ckbox3456 .checkbox:nth-child(3) label{color:grey;} .checkbox.input:nth-child(3),
                           .ckbox3456 .checkbox:nth-child(4) label{color:grey;} .checkbox.input:nth-child(4),
                           .ckbox3456 .checkbox:nth-child(5) label{color:grey;} .checkbox.input:nth-child(5),
                           .ckbox3456 .checkbox:nth-child(6) label{color:grey;} .checkbox.input:nth-child(6),
                           ...
                           .ckbox_3 .checkbox:nth-child(3) label{color:grey;} .checkbox.input:nth-child(3),
      ...
      tags$style(HTML(".StatGrey  .radio:first-child  input[type=radio],
                                            ...
                                            .ckbox3456  .checkbox:nth-child(3)  input[type=checkbox],
                                            .ckbox3456  .checkbox:nth-child(4)  input[type=checkbox],
                                            .ckbox3456  .checkbox:nth-child(5)  input[type=checkbox],
                                            .ckbox3456  .checkbox:nth-child(6)  input[type=checkbox],
      ...
      tags$style(HTML(".statbox {margin-top: -30px; margin-bottom: 0px}
                                     ...
                                     .ckbox2 .radio:nth-child(12) label{font-weight:bold;}
