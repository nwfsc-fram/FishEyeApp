  ...
  fluidPage(title = "FISHEyE",
    ...
    tags$head(
      ...
      tags$style(HTML(".statbox {margin-top: -30px; margin-bottom: 0px}
                                     ...
                                     .statboxF  .checkbox:nth-child(17) label,
                                     .statboxC  .checkbox:nth-child(8) label,
                                     .statboxM  .checkbox:nth-child(7) label,
                                     .ckbox2 .checkbox:first-child label,
                                     .ckbox2 .checkbox:nth-child(2) label,
                                     .ckbox2 .checkbox:nth-child(12) label,
                                     .ckboxFR .checkbox:first-child label,
                                     .rbFR .radio:first-child label,

                                     .statboxC  .radio:first-child label, 
                                     .statboxC  .radio:first-child label,
                                     .statboxM  .radio:first-child label,
                                     .statboxF  .radio:first-child label,
                                     .statboxF  .radio:nth-child(17) label,
                                     .statboxC  .radio:nth-child(8) label,
                                     .statboxM  .radio:nth-child(7) label,
                                    ...
                                    .statboxF .radio:nth-child(-n+20) label,
                                    ...
                                    .ckboxFR .checkbox:nth-child(2) label,
                                    .ckboxFR .checkbox:nth-child(5) label,
                                    .rbFR .radio:nth-child(2) label,
                                    .rbFR .radio:nth-child(5) label,
      ...
      tags$style(HTML(".ckbox2 .checkbox:nth-child(-n+15) label,
                                      ...
                                      .ckboxFR .checkbox:nth-child(3) label,
                                      .ckboxFR .checkbox:nth-child(4) label,
                                      .rbFR .radio:nth-child(3) label,
                                      .rbFR .radio:nth-child(4) label,
                                      .ckbox3 .radio:nth-child(5) label,
                                      .ckbox3 .radio:nth-child(6) label,
                                      .ckbox3 .radio:nth-child(8) label,
                                      .ckbox3 .radio:nth-child(9) label,
          ...
          mainPanel(
            tabsetPanel(id = "tabs",
                        ...
                        tabPanel("Description", value = "Panel3", 
                                 tags$a(href= paste0("pmtechmemo.html#", distinct(DatSubRaw()$link),
